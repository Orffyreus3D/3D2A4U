namespace _3D2A4U_Manager
{
    partial class EditLookupValues
    {
		...
		private void InitializeComponent()
		{
			...
			btnAddValue.Size = new Size(46, 23);
			...
			// btnRemoveValue
			// 
			btnRemoveValue.Location = new Point(62, 409);
			btnRemoveValue.Name = "btnRemoveValue";
			btnRemoveValue.Size = new Size(59, 23);
			...
			// btnSortUp
			// 
			btnSortUp.Location = new Point(175, 409);
			...
			// btnSortDown
			// 
			btnSortDown.Location = new Point(211, 409);
			...
			// btnSort
			// 
			btnSort.Location = new Point(125, 409);
			btnSort.Name = "btnSort";
			btnSort.Size = new Size(46, 23);
			btnSort.TabIndex = 7;
			btnSort.Text = "Sort";
