namespace _3D2A4U_Manager
{
    partial class Main
    {
		...
		private void InitializeComponent()
		{
			...
			// 
			spcFileSearch.Panel1.Controls.Add(label8);
			...
			label8.TabIndex = 5;
			label8.Text = "Double-click a row to edit it";
			// 
			// lblMessage
			// 
			...
			gvFileSearchResults.DoubleClick += gvFileSearchResults_DoubleClick;
			// 
			// tabVendors
			// 
			...
			tabMerge.Size = new Size(1416, 833);
			tabMerge.TabIndex = 6;
			tabMerge.Text = "Merge Wads";
